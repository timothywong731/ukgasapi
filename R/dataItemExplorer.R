...
#' @param apiurl A character object which points to National Grid's SOAP API. Defaults to 'http://marketinformation.natgrid.co.uk/MIPIws-public/public/publicwebservice.asmx'
...
#' response <- dataItemExplorer(dataitems,fromdate = '2013-10-01')
#'
